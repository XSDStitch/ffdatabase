...
public class NewItem {
	...
	public NewItem() {
		...
		userPanel.add(discription, cc.xy(1, 5));
		userPanel.add(discriptionArea, cc.xywh(3, 5, 1, 3));

		userPanel.add(picture, cc.xywh(5, 1, 1, 5));
		userPanel.add(chooseFile, cc.xy(5, 7));
		
		userPanel.add(save, cc.xywh(1, 9, 5, 1));

		userPanel.setBorder(Borders.DLU4);

		newItem.add(userPanel);
		newItem.setSize(600, 300);
